// Generated by ego on Mon May 30 12:49:39 2016.
// DO NOT EDIT
...
_, _ = fmt.Fprint(w, "\">")
//line templates/query.ego:129
_, _ = fmt.Fprint(w, html.EscapeString(fmt.Sprintf("%v",  temp )))
//line templates/query.ego:129
_, _ = fmt.Fprint(w, "</td>\n      ")
...
_, _ = fmt.Fprint(w, html.EscapeString(fmt.Sprintf("%v",  reading.MeasurementTimestamp.Format("15:04:05 Mon Jan _2") )))
//line templates/query.ego:132
_, _ = fmt.Fprint(w, "</td>\n      <td>")
